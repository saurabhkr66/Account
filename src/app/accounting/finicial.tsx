...
const services = [
  {
    id: 1,
    title: "Save Time & Reduce Overheads",
    content:
      "Maintaining an in-house accounting team can be expensive and time-consuming. Outsourcing accounting tasks allows businesses to cut operational costs while ensuring compliance and accuracy, letting you focus on your core business activities."
  },
  {
    id: 2,
    title: "Stay Compliant & Avoid Penalties",
    content:
      "With frequent changes in tax laws and financial regulations, staying compliant is challenging. Expert accountants ensure timely filing, accurate records, and full adherence to regulatory standards—minimizing your risk of penalties and audits."
  },
  {
    id: 3,
    title: "Gain Financial Insights & Forecasting",
    content:
      "Modern accounting isn’t just about balancing books—it’s about using data to drive decisions. Our accounting services provide real-time dashboards and financial reports, empowering you with insights for budgeting, planning, and business growth."
  },
]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            >
              Managing your business finances effectively is essential to long-term success.
              Our expert accounting services help reduce costs, improve compliance, and offer powerful financial insights.
              Here’s how partnering with us can elevate your accounting function:
            </motion.p>
