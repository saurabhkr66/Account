...
//             While bookkeeping provides the foundation, strategic accounting turns that financial data into your most powerful asset. It's about interpreting the numbers, 
//             planning for the future, and making informed decisions that drive profitability and growth. 
//             At Whiz Consulting, our expert accounting services provide the critical analysis and strategic insights your business needs to thrive in a competitive landscape.
//             </p>
//           </div>
//           <div className="relative">
//             {/* Mobile mockup */}
...
// Our Outsourced Accounting Services Include             </h2>
...
//       Many businesses miss out on potential savings and end up overpaying their taxes due to a lack of ongoing strategy. 
//       We provide proactive, year-round tax planning to identify every legal deduction and credit available to you.
//        This ensures you keep more of your hard-earned money while remaining fully compliant.
//             </p>
//           </div>
//           <div className="relative">
//             {/* Dashboard mockups */}
...
//               <h2 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-600 bg-clip-text text-transparent">
//              Unsure What the Numbers Mean?  </h2>
//             <p className="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
//          This point addresses the common challenge where business owners see financial reports but don't understand the story they tell. 
//          Our service acts as a translator, turning complex figures into clear, actionable insights about your business's performance.
//           This allows you to fully grasp your financial situation and make more informed decisions.
//             </p>
//           </div>
//         </div>
//       </div>
