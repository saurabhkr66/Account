  ...
  const faqs = [
    {
      ...
      answer:
"Absolutely. We use enterprise-grade security protocols, encrypted data transmission, and strict access controls to ensure your financial information is always protected and confidential."    },
    {
      question: "What accounting software do you work with?",
      answer:
"Our team is proficient in all major accounting platforms, including QuickBooks (Online & Desktop), Xero, Zoho Books, Sage, and more. We can adapt to your current software or help you migrate to a more suitable platform."    },
    {
      question: "How much do your bookkeeping services cost?",
      answer:
"Our pricing is flexible and based on the volume of transactions and the complexity of your needs. We offer customized packages that are more affordable than hiring an in-house employee. Contact us for a free, no-obligation quote."    },
    {
      question: "Can you work with my existing CPA or tax advisor?",
      answer:
"Yes. We collaborate seamlessly with CPAs and tax advisors, providing them with clean, accurate, and timely financial records to make tax season smooth and efficient."    },
    {
