...
import { ChevronDown, ChevronUp, MessageCircle, Shield, DollarSign, CheckCircle, Send,ArrowRight, Phone, MessageSquare } from 'lucide-react'
...
const faqs = [
  ...
  />
      ...
      <div className="relative z-10 dark:bg-blue-900/10 bg-blue-50 backdrop-blur-lg py-10">
  ...
  {faqs.map((faq, index) => (
    <Card
      key={index}
      className="dark:bg-blue-900/20 bg-white rounded-md shadow-sm hover:shadow-md transition-all duration-300 border border-blue-100 dark:border-blue-800/50"
    >
      <button
        onClick={() => toggleFaq(index)}
        className="w-full px-3 py-1 text-left flex items-center justify-between hover:bg-blue-50/50 dark:hover:bg-blue-900/30 transition-colors duration-200"
      >
        <span className="text-md font-medium dark:text-blue-100 text-blue-800 pr-2 leading-tight">
          {faq.question}
        </span>
        ...
        >
          <div className="px-3 pb-3">
            <div className="border-t border-blue-100 dark:border-blue-800/50 pt-2">
              <p className="text-sm dark:text-blue-200 text-blue-700 leading-snug">
                {faq.answer}
              </p>
            </div>
          </div>
    ...
    <div className="mt-16 text-center">
          <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-emerald-900 rounded-2xl p-8 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="outline" size="lg" className="bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white/20 group">
