...
export default function FaqContactSection() {
  ...
  const faqs = [
    {
      question: "What is payroll outsourcing services, and how do they benefit businesses?",
      answer:
        "Payroll outsourcing involves delegating your payroll processes to external specialists who handle everything from salary calculations to tax compliance. This allows businesses to focus on core operations while ensuring accurate, timely payroll processing and regulatory compliance.",
    },
    {
      question: "Is outsourcing payroll services secure?",
      answer:
        "Yes, reputable payroll outsourcing providers use advanced security measures including data encryption, secure servers, and compliance with industry standards like SOC 2. We maintain strict confidentiality protocols and regular security audits to protect your sensitive payroll data.",
    },
    {
      question: "How much does it cost to outsource payroll?",
      answer:
        "Payroll outsourcing costs vary based on company size, number of employees, and required services. Typically, it ranges from $20-$100 per employee per month. However, most businesses save money overall by reducing internal payroll costs, avoiding compliance penalties, and improving efficiency.",
    },
    {
      question: "What questions should I ask before outsourcing payroll?",
      answer:
        "Key questions include: What services are included? How do you ensure data security? What's your compliance track record? How do you handle customer support? What are the implementation timelines? Can you integrate with our existing systems? What are the total costs involved?",
    },
    {
