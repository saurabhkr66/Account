...
export default function SeamlessProcessesSection() {
  ...
  const switchFeatures = [
    "Automated ROC Filing Alerts",
    "Director KYC & DIN Management",
    "Form MGT-7 & AOC-4 Assistance",
    "Digital Signature (DSC) Renewal Reminders",
    "Seamless MCA Portal Integration",
    "Audit-Ready Compliance Reports",
  ]

  return (
    <div id="seamless-processes" className="relative dark:bg-gray-900 bg-gray-50">
      {/* Compliance Tracking Challenge */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-sky-400 to-blue-500 bg-clip-text text-transparent">
              Struggling to Track Compliance?
            </h2>

            <p className="dark:text-white/80 text-justify text-gray-600 text-lg leading-relaxed">
              Staying on top of MCA deadlines like annual filings, KYC updates, and director changes can be overwhelming. 
              Our MCA solutions give you a single dashboard to track filings, get timely alerts, and maintain full compliance without stress.
            </p>
          </div>
          ...
          >
            <div className="relative w-full max-w-md mx-auto">
              <Image
                src="/3.png"
                alt="MCA compliance tracking illustration"
                width={600}
                height={200}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative order-2 lg:order-1">
              <div className="relative w-full max-w-md mx-auto">
                <Image
                  src="/5.png"
                  alt="Manual filing burden illustration"
                  width={600}
                  height={200}
                  className="rounded-3xl object-cover"
                />
            ...
            >
              <h2 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-sky-400 to-blue-500 bg-clip-text text-transparent">
                Manual MCA Filing Is Risky
              </h2>

              <p className="dark:text-white/80 text-justify text-gray-600 text-lg leading-relaxed">
                Relying on spreadsheets or scattered documents to handle ROC filings can lead to missed deadlines, incorrect forms, and penalties. 
                We automate critical updates and offer structured workflows that reduce errors and ensure your filings are always on time and accurate.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Switch to Whiz for MCA Services */}
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold dark:text-white text-gray-900 leading-tight">
              ...
              <span className="bg-gradient-to-r from-sky-400 to-blue-500 bg-clip-text text-transparent">
                for Hassle-Free MCA Compliance
              </span>
            </h2>

            <p className="dark:text-white/80 text-gray-600 text-lg leading-relaxed">
              Whiz simplifies your MCA compliance with proactive alerts, pre-filled forms, expert assistance, 
              and a centralized portal. Whether you are a private limited company or an LLP, we’ve got your legal obligations covered.
            </p>
