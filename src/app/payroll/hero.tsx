...
// Updated phrases for Payroll Services
const phrases = [
  "Delays in Employee Salary Processing?",
  "Complex Compliance & Tax Filings?",
  "Manual Errors in Payslips or Deductions?",
]
          ...
          >
            <div className="space-y-4">
              ...
              <h3 className="text-2xl lg:text-3xl font-bold text-white">
                Let Us Handle Your Payroll Efficiently!
              </h3>
            </div>
