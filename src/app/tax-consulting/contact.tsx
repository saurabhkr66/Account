...
const faqs = [
  {
    question: "How can tax consulting save my business money?",
    answer:
      "Beyond just filing your taxes, we proactively identify credits and deductions, structure transactions for tax advantages, and develop long-term strategies to legally lower your overall tax liability, directly improving your profitability.",
  },
  {
    question: "My business is small. Do I still need a tax consultant?",
    answer:
      "Absolutely. Small businesses can benefit immensely from expert tax advice, which can prevent costly compliance mistakes and ensure you're not overpaying. A solid tax strategy is crucial for growth at any stage.",
  },
  {
    question: "What's the difference between a tax preparer and a tax consultant?",
    answer:
      "A tax preparer primarily focuses on filing historical tax returns. A tax consultant, like Whiz, does that and much more, offering year-round strategic advice, planning for future tax events, and helping you make business decisions with tax implications in mind.",
  },
  {
    question: "How do you handle audits from tax authorities?",
    answer:
      "Our experienced team will manage the entire audit process from start to finish. We handle all communication with the tax agency, prepare all necessary documentation, and represent your interests to ensure a smooth and fair process.",
  },
]
